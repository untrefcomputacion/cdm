...
return array(
    ...
    "The two given tokens do not match" => "Los dos campos no concuerdan",
    ...
    "'%value%' does not appear to be an integer" => "'%value%' debe ser un numero entero",
    ...
    "Value is required and can't be empty" => "Este campo no puede estar vacio",
